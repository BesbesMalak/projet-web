          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="index.php" id="dropdown01" data-toggle="dropdown" aria-expanded="false">Gestion des Groupes</a>              <div class="dropdown-menu" aria-labelledby="dropdown01">
                ...
                <a class="dropdown-item" href="supprimererGroupe.php">Supprimer Groupe</a>
...
while($classe = $stmt->fetch(PDO::FETCH_ASSOC)){
  $id = $classe['id_groupe'];
  $name_classe = $classe['name_classe'];
...
?>
     <tr>
         ...
         <td>
             <?php 
                 if (isset($_POST['delete-delete-classe'])) {
             ...
             ?>
                      ...
                      <form action="supprimerGroupe.php" method="POST">
                         <input type="hidden" name="id" value="supprimer" />
                         <button name="delete-delete-classe" class="btn btn-danger">Supprimer</button>
                     </form>  
