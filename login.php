...
<form id="myForm" class="form-signin" action="index.php">
  ...
  <button class="btn btn-lg btn-primary btn-block" name="valider" value="S'authentifier" type="submit">Se Connecter</button>
