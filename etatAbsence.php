...
<datalist id="classe" name="classe">
    ...
    <option value="1-INFOE">1-INFOE</option>
                    ...
                    <button type="button " onclick="afficher()" class="btn btn-info btn-block" name="afficher">Afficher</button>
                </div>
            </form>
        </div>
                        ...
                        include("connexion.php");
                            if (isset($_POST['afficher'])) {
                                ...
                                while ($etudiants = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                    $nomEtd = $etudiants ['nomEtd'];
                                    $classe = $etudiants ['classe'];
                                    $dateAbs = $etudiants ['dateAbs'];
                                    $module = $etudiants ['module'];
                                    $typeAbs = $etudiants ['typeAbs'];
                        ?>
                                    <tr>
                                        <td>
                                            <?php echo $nomEtd ?>
